...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen flex items-center justify-center overflow-hidden bg-stone-50">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          Handmade, custom-designed nameplates that tell your story. 
          Elevate your entrance with a touch of art and elegance.
        </p>
